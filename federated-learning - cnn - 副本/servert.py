...
sales_product_1 = [10, 20, 31, 44, 53]
sales_product_2 = [51, 85, 169, 285, 325]
sales_product_3 = [30, 50, 70, 98, 125]
...
#ax.set_title("Server Computing Cost Comparison", fontsize=15)
ax.set_xlabel("Number of terminal devices")
ax.set_ylabel("Server communication cost (s)")
ax.legend()
